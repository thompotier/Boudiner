					...
					<header id="header">
						...
						<nav class="links">
							<ul>
                                ...
                                <?php
								//si le conncetŽ est perseonnel
								if (isset($_SESSION['droit']) && $_SESSION['droit']=='3') {
										echo'<li><a href="gesappart.php">GŽrer appartement</a></li>
											<li><a href="gesentretien.php">GŽrer les entretiens</a></li>
							...
							<section>
								<ul class="actions vertical">
									...
									if (isset($_SESSION['nom'])) {
										echo'<li><a href="deconnexion.php" class="button big fit">DŽconnexion</a></li>';
									}
									else {
						...
						<!-- Intro -->
							<section id="intro">
								...
								<header>
                                    <?php
                                    echo'
									<h2>Mettre une option (demande entretien) </h2>
                                    ';
                                    ?>
								</header>
							</section>
						...
						<?php
                            echo'
                                ...
                                <section class="form">
                                    ...
                                    <br>Votre ID : '.$_SESSION['idutil'].'
                                    <form method="post" action="optionAppartTraite.php">
                                        <label for="pseudo"> Date entretien voulu : (AAAA-MM-JJ)</label>
